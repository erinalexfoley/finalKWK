...
class Y_Action_ViewController: UIViewController {
    ...
    @IBAction func segeValChanged(_ sender: Any) {
        ...
        link5 = "https://www.islamicreliefcanada.org/get-involved/volunteer/"
          ...
          button3.setTitle( "" , for: .normal )
          button4.setTitle( "" , for: .normal )
          button5.setTitle( "Link to Infographic" , for: .normal )
            link1 = ""
            link2 = ""
            link3 = ""
            link4 = ""
            link5 = "https://www.canva.com/design/DAEEyxD_MKc/share/preview?token=FRO5P4WS_SS926wH3tGUeA&role=EDITOR&utm_content=DAEEyxD_MKc&utm_campaign=designshare&utm_medium=link&utm_source=sharebutton"
          infoImage.image = UIImage(named: "YEMEN")
        }
    }
